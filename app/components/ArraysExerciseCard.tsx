...
const ARRAYS_EXERCISE_ADDRESS = '0xbE04F0E14f34bcc1169013d3738b7FA7c543062F' as const
...
export default function ArraysExerciseCard() {
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-6">
      <h2 className="text-lg font-medium mb-4">ArraysExercise</h2>
